...
require("./app3.js");
require("./app4.js");
_app1JsDefault.default.init('#1');

},{"./reset.css":"5dMMQ","./global.css":"2yhtl","./app1.js":"6OJP0","./app2.js":"1bsR9","./app3.js":"4knbM","./app4.js":"3XxMI","@parcel/transformer-js/lib/esmodule-helpers.js":"3GKdu"}],"5dMMQ":[function() {},{}],"2yhtl":[function() {},{}],"6OJP0":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
...
const control = {
  start: null,
  init(container) {
    control.start = _jqueryDefault.default(container);
    model.update({
      number: 1001
    });
...
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
var _jqueryDefault = _parcelHelpers.interopDefault(_jquery);
$top = _jqueryDefault.default("#bar");
$down = _jqueryDefault.default("#content");
$top.on('click', 'ol', e => {
  const $clicked = _jqueryDefault.default(e.currentTarget);
  const index = $clicked.index();
  $clicked.addClass('selected').siblings().removeClass('selected');
  $down.children().eq(index).addClass('active').siblings().removeClass('active');
});
...
},{"./app4.css":"6SFnb","jquery":"6Oaih","@parcel/transformer-js/lib/esmodule-helpers.js":"3GKdu"}],"6SFnb":[function() {},{}]},["1Ypau","30Yv7"], "30Yv7", "parcelRequire427e")
